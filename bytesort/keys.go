...
type SimpleComparableKey struct {
	ComparableLen uint8
	Comparable uint32
	ValueOffset uint64
	ValueLen uint32
...
func NewSimpleKey(comparable uint32, valueOffset uint64, valueLen uint32) *SimpleComparableKey {
	return &SimpleComparableKey{
		ComparableLen: 0,
...
func (k *SimpleComparableKey) Unmarshal(bts []byte) {
...
func (k *SimpleComparableKey) Marshal() []byte {
